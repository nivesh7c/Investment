        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            <a class="navbar-brand" href="index.html">
              ...
              <h3 class="brand-text">Investment Admin</h3>
            </a>
          </li>
  ...
  <footer class="footer fixed-bottom footer-dark navbar-border navbar-shadow">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
      <span class="float-md-left d-block d-md-inline-block"> <a class="text-bold-800 grey darken-2" href=""
        target="_blank">Investment</a> </span>
      <span class="float-md-right d-block d-md-inline-blockd-none d-lg-block">Design by Nivesh<i class="ft-heart pink"></i></span>
    </p>
  </footer>
  <!-- BEGIN VENDOR JS-->
